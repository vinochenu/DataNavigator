...
public class DN_withdrawal_pojo {
	...
	public int getUNIQUENESS_KEY() {
		return UNIQUENESS_KEY;
	}
	public void setUNIQUENESS_KEY(int uNIQUENESS_KEY) {
	...
	public float getAMT_RECON_NET() {
		return AMT_RECON_NET;
	}
	public void setAMT_RECON_NET(float aMT_RECON_NET) {
	...
	public int getSYS_TRACE_AUDIT_NO() {
		return SYS_TRACE_AUDIT_NO;
	}
	public void setSYS_TRACE_AUDIT_NO(int sYS_TRACE_AUDIT_NO) {
